...
{
  Given array A from const Arr, count all of it's elements.
  Output: number of same elements in given sequence
}
...
const
  M = 15;
  Arr: Array [1..M] of Integer = (1,4,5,1,4,6,7,8,3,1,5,6,1,1,4);
